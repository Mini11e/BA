...
\begin{document}
    ...
    \thispagestyle{empty}
    \vspace{4cm}
    \LARGE{University of Osnabrück}\\[-0.9ex]
    \LARGE{Institute of Cognitive Science}\\[2ex]
    ...
    \vspace{1.2cm}
    \Large{\textbf{Noise-Induced Synchrony and the Effects on Spike Pattern Length in a Spiking Neural Network}}\\[-0.5ex]
    %\large{Lorem ipsum dolor sit amet, consectetur adipiscing elit}\\[-1.5ex]
    \bigskip\par
    by \par
    \large{Dalia Muth}\\[-1ex]
    \large{Matriculation Nr.: 1005371}\\ [-1ex]
    \vspace{0.6cm}
    \end{center}
    \medskip
    \end{center}
    \begin{tabular}{ll}
    Submission Date:  & 6th April 2026 \\[-1ex]
    \vspace{0.1cm}
    Supervisors: & MSc. Viktoriia Zemliak, Prof. Gordon Pipa \\
    \end{tabular}
