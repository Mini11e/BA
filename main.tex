...
\begin{document}
	...
	\begin{multicols}{2}
        ...
        \begin{multicols}{2}
            ...
            \end{enumerate}
            It has to be noted that these observations are very sparse, because they were done after the experimental run and most noise conditions did not serve to investigate this interaction without additional measures. Further experiments with more examples would be necessary to confirm my assumptions.
