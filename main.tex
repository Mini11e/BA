...
\begin{document}
	...
	\begin{multicols}{2}
        ...
        \begin{multicols}{2}
            ...
            \begin{enumerate}[label=(\arabic*)]
                \item\label{diffsep} Similar pattern lengths but different separability intervals (loc 0.7, scale 0.3, 40 mV, higher separability; loc 0.8, scale 0.3, 40 mV, lower separability).
                \item\label{diffpattern} Different pattern lengths but similar separability intervals (loc 0.5, scale 0.7, 40 mV, longer patterns; loc 0.8, scale 0.3, 40 mV, shorter patterns).
            \end{enumerate}
